  ...
  const staffMembers: StaffMember[] = [
    {
      ...
      alt: 'Professional owner of Sample Assisted Living',
      bio: 'Founded Sample Assisted Living with a vision of providing compassionate, faith-centered care for seniors in the community. Their dedication to quality and personal touch sets the standard for everything we do.',
      philosophy: 'I started this home because I believe every senior deserves a place where they feel loved, respected, and truly at home. This isn\'t just a business—it\'s a calling guided by compassion and care.'
    },
    {
      name: 'Staff Member',
      role: 'Manager',
      ...
      alt: 'Professional manager at Sample Assisted Living',
      bio: 'Oversees daily operations at Sample Assisted Living, ensuring our residents receive consistent, high-quality care. Their nursing background and management expertise keep everything running smoothly.',
    ...
    },
    {
      ...
      alt: 'Healthcare worker at Sample Assisted Living',
    ...
    },
    {
      ...
      alt: 'Caregiver at Sample Assisted Living',
